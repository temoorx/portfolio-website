...
List<ProjectUtils> projectUtils = [
  ProjectUtils(
    ...
    links: 'https://github.com/Taimoornb/poetically-.git',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Taimoornb/',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Taimoornb/elderly_exercise_app.git',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Taimoornb/flutter_plant_app.git',
  ),
];
